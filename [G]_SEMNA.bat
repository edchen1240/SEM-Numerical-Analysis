...
REM SETTINGS
REM ==================================================
set "WORKDIR=D:\01_Floor\a_Ed\09_EECS\10_Python\04_Ready"
set "TARGET_DIR=2024-0828_SEM Numerical Analysis"
set "REPO_URL=git@github.com:edchen1240/SEM-Numerical-Analysis.git"
set "BRANCH=main"
